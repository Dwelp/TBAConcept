...
public class SetDataPlaymaker : SetDataSceneBase {
	...
	void OnGUI()
	{
		...
		DrawLabel("GDE Playmaker Set Data Test Scene");
		if (DrawButton("Reset All"))
	...
	void DrawListData()
	{
		DrawLabel("GDE Playmaker Arrays are not supported yet. Stay Tuned!");
	}
}
#endif
